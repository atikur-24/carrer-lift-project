    ...
    return (
        <header className='px-12 md:px-32 pt-10 bg-[#F9F9FF]'>
            <div className='md:flex justify-between items-center'>
                <h1 className='font-extrabold text-xl md:text-3xl tracking-wide'>Career Lift</h1>
                <nav className='space-x-8'>
                    ...
                    <NavLink  className={({ isActive }) => (isActive ? 'active' : 'default')} to='/apply'>Applied Jobs</NavLink>
